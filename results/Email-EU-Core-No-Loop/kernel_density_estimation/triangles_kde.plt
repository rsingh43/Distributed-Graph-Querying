...
plot "triangle_measures.csv" using 3:(0.005625*rand(0)-0.005625) linestyle 4 notitle ,\
...
set output "avg_nbr_deg_triangles.eps"
set title "Kernel Density Estimation\nfor Triangle Vertices"
set xrange[0:600]
set yrange [-0.003:0.012]
plot "triangle_measures.csv" using 9:(0.003*rand(0)-0.003) linestyle 4 notitle ,\
     "triangle_measures.csv" using 9:1 smooth kdensity linestyle 4 title "Average Neighbor Degree"

set output "avg_nbr_in_deg_triangles.eps"
set title "Kernel Density Estimation\nfor Triangle Vertices"
set xrange[0:250]
set yrange [-0.00625:0.025]
plot "triangle_measures.csv" using 10:(0.00625*rand(0)-0.00625) linestyle 4 notitle ,\
     "triangle_measures.csv" using 10:1 smooth kdensity linestyle 4 title "Average Neighbor In-Degree"

set output "avg_nbr_out_deg_triangles.eps"
set title "Kernel Density Estimation\nfor Triangle Vertices"
set xrange[0:350]
set yrange [-0.00625:0.025]
plot "triangle_measures.csv" using 11:(0.00625*rand(0)-0.00625) linestyle 4 notitle ,\
     "triangle_measures.csv" using 11:1 smooth kdensity linestyle 4 title "Average Neighbor Out-Degree"

set output "sum_nbr_deg_triangles.eps"
set title "Kernel Density Estimation\nfor Triangle Vertices"
set xrange[0:30000]
set yrange [-0.00005:0.0002]
plot "triangle_measures.csv" using 12:(0.00005*rand(0)-0.00005) linestyle 4 notitle ,\
     "triangle_measures.csv" using 12:1 smooth kdensity linestyle 4 title "Sum Neighbor Degree"

set output "sum_nbr_in_deg_triangles.eps"
set title "Kernel Density Estimation\nfor Triangle Vertices"
set xrange[0:15000]
set yrange [-0.0001:0.0004]
plot "triangle_measures.csv" using 13:(0.0001*rand(0)-0.0001) linestyle 4 notitle ,\
     "triangle_measures.csv" using 13:1 smooth kdensity linestyle 4 title "Sum Neighbor In-Degree"

set output "sum_nbr_out_deg_triangles.eps"
set title "Kernel Density Estimation\nfor Triangle Vertices"
set xrange[0:15000]
set yrange [-0.0001:0.0004]
plot "triangle_measures.csv" using 14:(0.0001*rand(0)-0.0001) linestyle 4 notitle ,\
     "triangle_measures.csv" using 14:1 smooth kdensity linestyle 4 title "Sum Neighbor Out-Degree"
