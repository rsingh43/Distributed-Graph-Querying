...
"""
	...
	for ii in xrange(501):
		...
		#if triples == 24929	and triangles == 347700:
...
if __name__ == '__main__':
	parser = argparse.ArgumentParser(description="Triangle Count: Outside Standard Deviation", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
